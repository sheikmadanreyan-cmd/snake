...
def draw_snake(snake, direction, boosted):
    ...
    # Head
    head = snake[0]
    x, y = head[0]*CELL_SIZE, head[1]*CELL_SIZE
...
def game():
    ...
    while difficulty not in ("E","N","H"):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
    if difficulty=="E": normal_rate=5
    elif difficulty=="N": normal_rate=7
    else: normal_rate=10
    boost_extra=5

    snake, apple_position, obstacle_position, star_position, direction, score, boosted, boost_end_time, bh1, bh2 = reset_game_state()
    ...
    while running:
        ...
        if not menu_active:
            ...
            if not ate_apple:
                snake.pop()
            if boosted and now>boost_end_time:
                boosted=False
        ...
        if menu_active:
            ...
            if confirm_active:
                ...
                msg=("Restart game? All progress will be lost." if confirm_action=="restart"
